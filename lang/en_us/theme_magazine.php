...
/**
 * Strings for component 'theme_magazine', language 'en_us', version '3.9'.
 *
...
$string['linkhoverdesc'] = 'Set the color of links in the theme. Use html hex code.';
$string['maincolor'] = 'Main color';
$string['maincoloraccent'] = 'Main color accent';
...
$string['maincolordesc'] = 'Dark accent color for the dock bar and header borders. Should be slightly darker than the main color.';
