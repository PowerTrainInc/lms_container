...
/**
 * Strings for component 'local_moodleorg', language 'en_us', version '3.9'.
 *
...
$string['downloadintro'] = 'Moodle is open source under the <a href="http://docs.moodle.org/dev/License">GPL license</a>. Everything we produce is available for you to download and use for free.';
...
$string['statsenrolments'] = 'Enrollments';
$string['supportforums'] = 'Our user community mostly communicates via forums inside "courses" on this Moodle-based site.  You must "enroll" in the course to post to forums (enrollment is completely free).';
