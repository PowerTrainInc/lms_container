...
/**
 * Strings for component 'format_topcoll', language 'en_us', version '3.9'.
 *
...
$string['defaulttogglealignment_desc'] = 'Toggle Left, Center, or Right Alignment';
$string['defaulttoggleallhover_desc'] = 'Toggle No/Yes';
$string['defaulttoggleborderradiusbl_desc'] = 'Toggle bottom left border radius descending';
$string['defaulttoggleborderradiusbr_desc'] = 'Toggle bottom right border radius descending';
$string['defaulttoggleborderradiustl_desc'] = 'Toggle top left border radius descending';
$string['defaulttoggleborderradiustr_desc'] = 'Toggle top right border radius descending';
