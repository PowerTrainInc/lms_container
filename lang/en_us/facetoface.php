...
/**
 * Strings for component 'facetoface', language 'en_us', version '3.9'.
 *
 * @package     facetoface
 * @category    string
...
When a face-to-face session reaches capacity the session details do not appear on the course page. The details will appear greyed out on the \'View all sessions\' page and the learner cannot enroll on the session.
&nbsp;';
$string['description_help'] = '**Description** is the course description that displays when a learner enrolls on a face-to-face session.

The **Description** also displays in the training calendar.';
$string['enrolled'] = 'enrolled';
$string['error:enrolmentfailed'] = 'Could not enroll {$a} into the course.';
