...
/**
 * Strings for component 'plagiarism_compilatio', language 'en_us', version '3.9'.
 *
...
$string['compilatio'] = 'Compilatio plagiarism-detection plugin';
$string['compilatiodefaults'] = 'Default values for Compilatio';
