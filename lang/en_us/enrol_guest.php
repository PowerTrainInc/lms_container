...
/**
 * Strings for component 'enrol_guest', language 'en_us', version '3.9'.
 *
 * @package     enrol_guest
 * @category    string
...
';
$string['privacy:metadata'] = 'The Guest access enrollment plugin does not store any personal data.';
