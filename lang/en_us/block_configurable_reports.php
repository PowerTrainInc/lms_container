...
/**
 * Strings for component 'block_configurable_reports', language 'en_us', version '3.9'.
 *
...
$string['statsactiveenrolments'] = 'Active (last week) enrollments';
$string['statstotalenrolments'] = 'Total enrollments';
