...
/**
 * Strings for component 'enrol_profilefield', language 'en_us', version '3.9'.
 *
...
$string['enrolname'] = 'Profile Field Enrollment';
...
$string['pluginname'] = 'Profile Field Enrollment';
$string['pluginname_desc'] = 'This method allows direct enrollment in course if user has a profile field set to the expected value';
$string['profilefield:config'] = 'Can configure the enrollment instance';
$string['profilefield:manage'] = 'Can manage enrollments on profile fields';
