...
/**
 * Strings for component 'enrol_elightenment', language 'en_us', version '3.9'.
 *
...
$string['defaultrole_desc'] = 'Select role which should be assigned to users during enrollments';
$string['elightenment:config'] = 'Configure enroll instances';
$string['elightenment:manage'] = 'Manage enrolled users';
$string['elightenment:unenrol'] = 'Unenroll users from course';
$string['elightenment:unenrolself'] = 'Unenroll self from the course';
$string['enrolenddate_help'] = 'If enabled, users can be enrolled until this date only.';
$string['enrolenddaterror'] = 'Enrollment end date cannot be earlier than start date';
$string['enrolperiod'] = 'Enrollment/Subscription duration';
$string['enrolperiod_desc'] = 'Default length of time that the enrollment is valid. This must be set if this course is a subscription!';
...
$string['status'] = 'Allow paid enrollments';
$string['status_desc'] = 'Allow users to use enlightenment to enroll into a course by default.';
