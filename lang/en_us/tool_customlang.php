...
/**
 * Strings for component 'tool_customlang', language 'en_us', version '3.9'.
 *
...
$string['confirmcheckin'] = 'You are about to save modifications to your local language pack. This will export the customized strings from the translator into you Moodle data directory and Moodle will start using the modified strings. Press \'Continue\' to proceed with saving.';
