...
/**
 * Strings for component 'tool_lp', language 'en_us', version '3.9'.
 *
 * @package     tool_lp
 * @category    string
...
$string['templatecohortnotsyncedwhileduedateispassed'] = 'Cohorts will not be synchronized if the template\'s due date has passed.';
