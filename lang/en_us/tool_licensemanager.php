...
/**
 * Strings for component 'tool_licensemanager', language 'en_us', version '3.9'.
 *
...
$string['disablelicensename'] = 'Disable license \'{$a}\'';
$string['duplicatelicenseshortname'] = 'The license short name must be unique.';
$string['editlicense'] = 'Edit license';
$string['editlicensename'] = 'Edit license \'{$a}\'';
$string['enablelicensename'] = 'Enable license \'{$a}\'';
...
$string['movelicensedownname'] = 'Move \'{$a}\' license down';
$string['movelicenseupname'] = 'Move \'{$a}\' license up';
...
$string['version_help'] = 'Publication date of the license version being utilized.';
