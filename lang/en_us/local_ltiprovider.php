...
/**
 * Strings for component 'local_ltiprovider', language 'en_us', version '3.9'.
 *
...
$string['enrolandunenrol'] = 'Enroll new and unenroll missing members';
$string['enrolenddaterror'] = 'Enrollment end date cannot be earlier than start date';
$string['enrolmentfinished'] = 'The enrollment period has finished';
$string['enrolmentnotstarted'] = 'The enrollment period has not started';
$string['enrolnew'] = 'Enroll new members';
...
$string['unenrolmissing'] = 'Unenroll missing members';
