 ...
 * @license    All Rights Reserved
 */
class mod_customcertpwt_element_helper_testcase extends advanced_testcase {
    ...
    /**
     * Tests we are returning the correct course id for an element in a course customcertpwt activity.
     */
    public function test_get_courseid_element_in_course_certificate() {
        ...
        $template = $DB->get_record('customcertpwt_templates', array('contextid' => context_module::instance($customcertpwt->cmid)->id));
        ...
        $element->sequence = \mod_customcertpwt\element_helper::get_element_sequence($element->pageid);
        $element->timecreated = time();
        $element->id = $DB->insert_record('customcertpwt_elements', $element);

        // Confirm the correct course id is returned.
        $this->assertEquals($course->id, \mod_customcertpwt\element_helper::get_courseid($element->id));
    }
    ...
    public function test_get_courseid_element_in_site_template() {
        ...
        $template = \mod_customcertpwt\template::create('Site template', context_system::instance()->id);
        ...
        // Confirm the correct course id is returned.
        $this->assertEquals($SITE->id, \mod_customcertpwt\element_helper::get_courseid($element->id));
    }

    /**
     * Tests we are returning the correct course module id for an element in a course customcertpwt activity.
     */
    public function test_get_context_element_in_course_certificate() {
        ...
        $this->assertEquals(context_module::instance($customcertpwt->cmid),
            \mod_customcertpwt\element_helper::get_context($element->id));
    }
    ...
    public function test_get_context_element_in_site_template() {
        ...
        // Confirm the correct course module id is returned.
        $this->assertEquals(context_system::instance(), \mod_customcertpwt\element_helper::get_context($element->id));
    }
    ...
    public function test_get_grade_items() {
        ...
        $gradeitems = \mod_customcertpwt\element_helper::get_grade_items($course);
