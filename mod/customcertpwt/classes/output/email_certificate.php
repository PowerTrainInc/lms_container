...
class email_certificate implements \renderable, \templatable {
    ...
    public function export_for_template(\renderer_base $renderer) {
        ...
        if ($this->isstudent) {
            $data->emailgreeting = get_string('emailstudentgreeting', 'customcertpwt', $this->userfullname);
            $data->emailbody = get_string('emailstudentbody', 'customcertpwt', $info);
            $data->emailbodyplaintext = get_string('emailstudentbodyplaintext', 'customcertpwt', $info);
            $data->emailcertificatelink = new \moodle_url('/mod/customcertpwt/view.php', array('id' => $this->cmid));
            $data->emailcertificatetext = get_string('emailstudentcertificatelinktext', 'customcertpwt');
        } else {
            $data->emailgreeting = get_string('emailnonstudentgreeting', 'customcertpwt');
            $data->emailbody = get_string('emailnonstudentbody', 'customcertpwt', $info);
            $data->emailbodyplaintext = get_string('emailnonstudentbodyplaintext', 'customcertpwt', $info);
            $data->emailcertificatelink = new \moodle_url('/mod/customcertpwt/view.php', array('id' => $this->cmid));
            $data->emailcertificatetext = get_string('emailnonstudentcertificatelinktext', 'customcertpwt');
        }
