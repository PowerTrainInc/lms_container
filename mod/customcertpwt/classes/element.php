...
/**
 * The base class for the customcertpwt elements.
 *
 ...
 * Class element
 *
 * All customcertpwt element plugins are based on this class.
 *
 * @package    mod_customcertpwt
 * @copyright  2021 PowerTrain Inc
 * @license    All rights Reserved
...
abstract class element {
    ...
    public function __construct($element) {
        $showposxy = get_config('customcertpwt', 'showposxy');
    ...
    public function save_form_elements($data) {
        ...
        if (!empty($this->id)) { // Must be updating a record in the database.
            $element->id = $this->id;
            return $DB->update_record('customcertpwt_elements', $element);
            ...
            return $DB->insert_record('customcertpwt_elements', $element, false);
        }
    }
    ...
    public function delete() {
        ...
        return $DB->delete_records('customcertpwt_elements', array('id' => $this->id));
    }
     ...
     *
     * @param \mod_customcertpwt\edit_element_form $editelementform
     */
     ...
     *
     * @return \mod_customcertpwt\edit_element_form
     */
