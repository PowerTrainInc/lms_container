YUI.add('moodle-mod_customcertpwt-rearrange', function (Y, NAME) {

/**
 * Rearrange elements in the custom certificate
 *
 * @class Y.M.mod_customcertpwt.rearrange
 * @constructor
 */
...
Y.extend(Rearrange, Y.Base, {
    ...
    /**
     * The customcertpwt page we are displaying.
     */
    page: [],
    ...
    savepositions: function(e) {
        ...
        Y.io(M.cfg.wwwroot + '/mod/customcertpwt/ajax.php', {
            method: 'POST',
            data: params,
            on: {
...
Y.namespace('M.mod_customcertpwt.rearrange').init = function(templateid, page, elements) {
