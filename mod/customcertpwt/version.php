...
/**
 * Code fragment to define the version of the customcertpwt module
 *
...
$plugin->version   = 2021112902; // The current module version (Date: YYYYMMDDXX).
$plugin->requires  = 2020061500; // Requires this Moodle version (3.9).
$plugin->cron      = 0; // Period for cron to check this module (secs).
$plugin->component = 'mod_customcertpwt';
