 ...
 *
 * @module     mod_customcertpwt/rearrange-area
 * @package    mod_customcertpwt
 * @copyright  2021 PowerTrain Inc
 * @license    All Rights Reserved
 */
define(['jquery', 'core/yui', 'core/fragment', 'mod_customcertpwt/dialogue', 'core/notification',
        ...
        function($, Y, fragment, Dialogue, notification, str, template, ajax) {
            ...
            RearrangeArea.prototype.customcertpwt_REF_POINT_TOPLEFT = 0;
            RearrangeArea.prototype.customcertpwt_REF_POINT_TOPCENTER = 1;
            RearrangeArea.prototype.customcertpwt_REF_POINT_TOPRIGHT = 2;
            ...
            RearrangeArea.prototype._editElement = function(event) {
                ...
                fragment.loadFragment('mod_customcertpwt', 'editelement', contextid, params).done(function(html, js) {
                    str.get_string('editelement', 'mod_customcertpwt').done(function(title) {
                ...
                body.on('click', '#id_submitbutton', function(e) {
                    ...
                    this._saveElement(elementid).then(function() {
                        ...
                        this._getElementHTML(elementid).done(function(html) {
                            ...
                            var refpointClass = '';
                            if (refpoint == this.customcertpwt_REF_POINT_TOPLEFT) {
                                refpointClass = 'refpoint-left';
                            } else if (refpoint == this.customcertpwt_REF_POINT_TOPCENTER) {
                                refpointClass = 'refpoint-center';
                            } else if (refpoint == this.customcertpwt_REF_POINT_TOPRIGHT) {
            ...
            RearrangeArea.prototype._setPosition = function(elementid, refpoint, posx, posy) {
                ...
                switch (refpoint) {
                    case this.customcertpwt_REF_POINT_TOPCENTER:
                        posx -= nodewidth / 2;
                        break;
                    case this.customcertpwt_REF_POINT_TOPRIGHT:
            ...
            RearrangeArea.prototype._getElementHTML = function(elementid) {
                ...
                var promises = ajax.call([{
                    methodname: 'mod_customcertpwt_get_element_html',
                    args: {
            ...
            RearrangeArea.prototype._saveElement = function(elementid) {
                ...
                var promises = ajax.call([{
                    methodname: 'mod_customcertpwt_save_element',
                    args: {
                        templateid: templateid,
                        elementid: elementid,
                        values: inputs
