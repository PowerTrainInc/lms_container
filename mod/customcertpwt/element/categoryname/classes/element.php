...
/**
 * This file contains the customcertpwt element categoryname's core interaction API.
 *
 * @package    customcertpwtelement_categoryname
 * @copyright  2021 PowerTrain Inc
 * @license    All Rights Reserved
 */

namespace customcertpwtelement_categoryname;

defined('MOODLE_INTERNAL') || die();

/**
 * The customcertpwt element categoryname's core interaction API.
 *
 * @package    customcertpwtelement_categoryname
 * @copyright  2021 PowerTrain Inc
 * @license    All rights Reserved
...
class element extends \mod_customcertpwt\element {
    ...
    public function render($pdf, $preview, $user) {
        \mod_customcertpwt\element_helper::render_content($pdf, $this, $this->get_category_name());
    }
    ...
    public function render_html() {
        return \mod_customcertpwt\element_helper::render_html_content($this, $this->get_category_name());
    }
    ...
    protected function get_category_name() : string {
        ...
        $courseid = \mod_customcertpwt\element_helper::get_courseid($this->get_id());
