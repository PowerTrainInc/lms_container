...
/**
 * This file contains the customcertpwt element userfield's core interaction API.
 *
 * @package    customcertpwtelement_userfield
 * @copyright  2021 PowerTrain Inc
 * @license    All Rights Reserved
 */

namespace customcertpwtelement_userfield;

defined('MOODLE_INTERNAL') || die();

/**
 * The customcertpwt element userfield's core interaction API.
 *
 * @package    customcertpwtelement_userfield
 * @copyright  2021 PowerTrain Inc
 * @license    All rights Reserved
...
class element extends \mod_customcertpwt\element {
    ...
    public function render_form_elements($mform) {
        ...
        $mform->addElement('select', 'userfield', get_string('userfield', 'customcertpwtelement_userfield'), $fields);
        $mform->setType('userfield', PARAM_ALPHANUM);
        $mform->addHelpButton('userfield', 'userfield', 'customcertpwtelement_userfield');
    ...
    public function render($pdf, $preview, $user) {
        \mod_customcertpwt\element_helper::render_content($pdf, $this, $this->get_user_field_value($user, $preview));
    }
