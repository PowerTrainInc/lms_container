...
/**
 * This file contains the customcertpwt element background image's core interaction API.
 *
 * @package    customcertpwtelement_bgimage
 * @copyright  2021 PowerTrain Inc
 * @license    All Rights Reserved
 */

namespace customcertpwtelement_bgimage;

defined('MOODLE_INTERNAL') || die();

/**
 * The customcertpwt element background image's core interaction API.
 *
 * @package    customcertpwtelement_bgimage
 * @copyright  2021 PowerTrain Inc
 * @license    All rights Reserved
