...
/**
 * This file contains the customcertpwt element gradeitemname's core interaction API.
 *
 * @package    customcertpwtelement_gradeitemname
 * @copyright  2021 PowerTrain Inc
 * @license    All Rights Reserved
 */

namespace customcertpwtelement_gradeitemname;

defined('MOODLE_INTERNAL') || die();

/**
 * The customcertpwt element gradeitemname's core interaction API.
 *
 * @package    customcertpwtelement_gradeitemname
 * @copyright  2021 PowerTrain Inc
 * @license    All rights Reserved
...
class element extends \mod_customcertpwt\element {
    ...
    public function render_form_elements($mform) {
        ...
        $mform->addElement('select', 'gradeitem', get_string('gradeitem', 'customcertpwtelement_gradeitemname'),
            \mod_customcertpwt\element_helper::get_grade_items($COURSE));
        $mform->addHelpButton('gradeitem', 'gradeitem', 'customcertpwtelement_gradeitemname');
    ...
    public function render($pdf, $preview, $user) {
        ...
        if (!empty($this->get_data())) {
            \mod_customcertpwt\element_helper::render_content($pdf, $this, $this->get_grade_item_name());
        }
    }
    ...
    public function render_html() {
        // Check that the grade item is not empty.
        if (!empty($this->get_data())) {
            return \mod_customcertpwt\element_helper::render_html_content($this, $this->get_grade_item_name());
        }
