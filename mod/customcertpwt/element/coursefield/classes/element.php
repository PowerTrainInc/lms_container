...
/**
 * This file contains the customcertpwt element coursefield's core interaction API.
 *
 * @package    customcertpwtelement_coursefield
 * @copyright  2021 PowerTrain Inc
 * @license    All Rights Reserved
 */

namespace customcertpwtelement_coursefield;

defined('MOODLE_INTERNAL') || die();

/**
 * The customcertpwt element coursefield's core interaction API.
 *
 * @package    customcertpwtelement_coursefield
 * @copyright  2021 PowerTrain Inc
 * @license    All rights Reserved
...
class element extends \mod_customcertpwt\element {
    ...
    public function render_form_elements($mform) {
        ...
        $mform->addElement('select', 'coursefield', get_string('coursefield', 'customcertpwtelement_coursefield'), $fields);
        $mform->setType('coursefield', PARAM_ALPHANUM);
        $mform->addHelpButton('coursefield', 'coursefield', 'customcertpwtelement_coursefield');
    ...
    public function render($pdf, $preview, $user) {
        ...
        \mod_customcertpwt\element_helper::render_content($pdf, $this, $this->get_course_field_value($course, $preview));
    }
    ...
    public function render_html() {
        ...
        return \mod_customcertpwt\element_helper::render_html_content($this, $this->get_course_field_value($COURSE, true));
    }
