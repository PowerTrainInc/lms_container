...
/**
 * customcertpwt image element upgrade code.
 *
 * @package    customcertpwt_element_image
 ...
 */
function xmldb_customcertpwtelement_image_upgrade($oldversion) {
    global $DB;

    if ($oldversion < 2016120501) {
        // Go through each 'image' element and update the file stored information.
        if ($images = $DB->get_records_select('customcertpwt_elements', $DB->sql_compare_text('element') . ' = \'image\'')) {
        ...
        // Savepoint reached.
        upgrade_plugin_savepoint(true, 2016120501, 'customcertpwt_element', 'image');
    }
